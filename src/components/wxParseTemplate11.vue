<template>
    ...
    <block v-if="node.node == 'element'">
        ...
        <!--audio类型-->
        <block v-else-if="node.tag == 'inneraudio'">
            <wx-parse-inner-audio :node="node"/>
        </block>
    ...
    <!--判断是否是文本节点-->
    <block v-else-if="node.node == 'text'">{{node.text}}11</block>
</template>
...
<script>
    /* eslint-disable */
		...
		import WxParseInnerAudio from './wxParseInnerAudio';
